...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        // Usuario ADMIN
        usuarioRepository.save(new Usuario("Administrador", "admin", "admin@sinfonia.com",  passwordAdmin, Role.ADMIN));

        // Usuario USER
        usuarioRepository.save(new Usuario("Usuario", "user", "user@sinfonia.com", passwordUser,  Role.USER));
